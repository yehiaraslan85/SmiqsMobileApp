...
namespace smiqs
{
    public static class AppConstants
    {
        ...
        /// </summary>
        public static string NotificationHubName { get; set; } = "smiqsnh";
        ...
        /// </summary>
        public static string ListenConnectionString { get; set; } = "Endpoint=sb://smiqsnhns.servicebus.windows.net/;SharedAccessKeyName=DefaultListenSharedAccessSignature;SharedAccessKey=rJX1V2cFu98PJBSLzjopcUUiXVQkb+jdfoHfn5UWbhs=";
